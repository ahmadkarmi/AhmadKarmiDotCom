...
export interface ApiAboutPageAboutPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    bioEmail: Schema.Attribute.Email;
    bioImage: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    bioLocation: Schema.Attribute.String;
    bioName: Schema.Attribute.String;
    bioRole: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Global site settings including CV and contact info';
  ...
  attributes: {
    ...
    cvButtonText: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Download CV'>;
    email: Schema.Attribute.Email;
...
export interface ApiWorkWork extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    status: Schema.Attribute.Enumeration<
      ['completed', 'proposal', 'concept', 'in_progress']
    > &
